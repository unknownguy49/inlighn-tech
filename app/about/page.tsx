        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
          <div className="text-center px-4 md:px-6 max-w-6xl mx-auto py-20">
            ...
            <div className="text-4xl md:text-6xl lg:text-8xl font-black mb-6 md:mb-8 text-white leading-tight">
              ...
              <br />
              <KineticText text="Tech " className="inline" type="words" delay={600} />
            ...
            <ScrollReveal delay={0.6}>
              <p className="text-lg md:text-xl lg:text-2xl mb-8 md:mb-12 text-gray-300 max-w-4xl mx-auto leading-relaxed">
                We're on a mission to bridge the gap between academic learning and industry requirements through
                immersive, hands-on technology education that transforms careers and lives.
              </p>
            </ScrollReveal>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            <div className="text-center">
              ...
              <ScrollReveal delay={0.3}>
                <p className="text-lg md:text-xl text-gray-300 mb-6 md:mb-8 leading-relaxed max-w-4xl mx-auto">
                  At InlighnTech, we believe that the future belongs to those who can adapt, innovate, and lead in the
                  digital age. Our mission is to empower students and young professionals with the practical skills,
                  industry knowledge, and confidence needed to excel in today's competitive tech landscape.
                </p>
              </ScrollReveal>
            </div>
          </div>
            ...
            <ScrollReveal>
              <div className="text-center mb-12 md:mb-16 lg:mb-20">
                <KineticText
                  ...
                  className="text-3xl md:text-5xl lg:text-6xl font-black text-white mb-6 md:mb-8"
                  type="words"
                />
              ...
              {teamLoading
                ...
                : team.map((member, index) => (
                    <ScrollReveal key={index} delay={index * 0.1}>
                      <Card className="bg-gray-900 border-gray-700 hover:shadow-xl hover:border-purple-400 hover:shadow-purple-500/20 transition-all duration-300 group h-full">
                        <CardContent className="p-6 md:p-8 text-center h-full flex flex-col">
                          ...
                          <p className="text-blue-400 mb-2 md:mb-3 font-medium text-sm md:text-base">{member.role}</p>
                          <p className="text-gray-300 text-xs md:text-sm flex-1">{member.expertise}</p>
                        </CardContent>
                      </Card>
                    </ScrollReveal>
                  ))}
