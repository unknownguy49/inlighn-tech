        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
          <div className="text-center px-4 md:px-6 max-w-6xl mx-auto py-20">
            <ScrollReveal delay={0.2}>
              <Badge
                variant="none"
                className="mb-6 md:mb-8 bg-green-500/10 text-green-600 dark:text-green-400 border-green-500/20 hover:bg-green-500/15 hover:border-green-500/30 hover:text-green-700 dark:hover:text-green-300 transition-all duration-300 px-4 md:px-6 py-2 md:py-3 text-sm md:text-lg font-semibold backdrop-blur-sm"
              >
                💬 Get In Touch
              </Badge>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.6}>
              <p className="text-lg md:text-xl lg:text-2xl mb-8 md:mb-12 text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                Have questions about our programs? Ready to apply? We're here to
                guide you every step of the way to your dream tech career.
              </p>
            </ScrollReveal>
          </div>
        </section>
                      ...
                      {!submitted ? (
                        ...
                        >
                          <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                            <div>
                              ...
                              <Input
                                ...
                                className="bg-muted border-border text-foreground placeholder:text-muted-foreground mt-2 md:mt-3 py-3 md:py-4 px-3 md:px-4 text-base md:text-lg rounded-xl"
                          ...
                          <div>
                            ...
                            <Textarea
                              ...
                              onChange={handleInputChange}
                              rows={6}
                              className="bg-muted border-border text-foreground placeholder:text-muted-foreground mt-2 md:mt-3 p-3 md:p-4 text-base md:text-lg rounded-xl"
                          ...
                          <WaterRipple>
                            <MagneticElement>
                              <Button
                                ...
                                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-foreground py-3 md:py-4 text-lg md:text-xl font-bold rounded-xl"
                              >
                                {isSubmitting ? (
                        ...
                        <div className="text-center py-12 md:py-16">
                          <div className="w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-green-600 to-emerald-600 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6">
                            <MessageCircle className="h-8 w-8 md:h-10 md:w-10 text-foreground" />
                          </div>
                          <h3 className="text-2xl md:text-3xl font-black text-foreground mb-4 md:mb-6">
                          ...
                          <p className="text-muted-foreground text-base md:text-lg mb-6 md:mb-8 leading-relaxed">
                            ...
                            get back to you within 2 hours during business
                            hours.
                          </p>
                        </div>
                      )}
              ...
              <div className="space-y-8 md:space-y-12">
                <ScrollReveal delay={0.2}>
                  <div>
                    <KineticText
                      text="Get In Touch"
                      className="text-3xl md:text-4xl font-black text-foreground mb-6 md:mb-8"
                      type="words"
                    />
                    <p className="text-lg md:text-xl text-muted-foreground mb-8 md:mb-12 leading-relaxed">
                      Ready to transform your career? We're here to guide you
                      every step of the way from application to job placement.
                    </p>
                  </div>
                </ScrollReveal>
                ...
                <div className="space-y-6 md:space-y-8">
                  {contactInfo.map((info, index) => (
                    <ScrollReveal key={index} delay={0.3 + index * 0.1}>
                      <WaterRipple>
                        <MagneticElement>
                          <Card className="bg-background border-gray-700 hover:shadow-xl hover:border-blue-400 hover:shadow-blue-500/20 transition-all duration-300 group">
                            <CardContent className="p-6 md:p-8">
                              <div className="flex items-start gap-4 md:gap-6">
                                ...
                                >
                                  <info.icon className="h-6 w-6 md:h-8 md:w-8 text-foreground" />
                                </div>
                                <div>
                                  <h3 className="text-lg md:text-2xl font-bold text-foreground mb-1 md:mb-2 group-hover:text-blue-400 transition-colors">
                                    {info.title}
                                  </h3>
                  ...
                  <WaterRipple>
                    <Card className="bg-blue-900/20 border-blue-800 hover:shadow-xl hover:border-blue-400 hover:shadow-blue-500/20 transition-all duration-300">
                      <CardContent className="p-6 md:p-8">
                        ...
                        <div className="space-y-2 md:space-y-3 text-muted-foreground text-base md:text-lg">
                          <p>
                          ...
                          <p className="text-blue-400 font-medium mt-3 md:mt-4 text-sm md:text-base">
                            📞 Emergency support available 24/7 for current
                            students
                          </p>
                        </div>
                      </CardContent>
