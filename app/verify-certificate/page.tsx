...
import { Search, Award, CheckCircle, XCircle, Calendar, BookOpen, Shield, Copy, Check } from "lucide-react"
...
export default function VerifyCertificatePage() {
  ...
  const exampleCertificates = ["INLT-2024-001", "INLT-2024-002", "INLT-2024-003", "INLT-2024-004"]
  ...
  const mockCertificates = {
    ...
    "INLT-2024-002": {
      ...
      grade: "A",
      finalScore: "92/100",
      skills: ["Ethical Hacking", "Network Security", "Penetration Testing", "Incident Response"],
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
          <div className="text-center px-4 md:px-6 max-w-6xl mx-auto py-20">
            <ScrollReveal delay={0.2}>
              <Badge className="mb-6 md:mb-8 bg-yellow-900/20 text-yellow-300 border-yellow-800 px-4 md:px-6 py-2 md:py-3 text-sm md:text-lg font-semibold backdrop-blur-sm">
                🏆 Certificate Verification
              </Badge>
            </ScrollReveal>

            <div className="text-4xl md:text-6xl lg:text-8xl font-black mb-6 md:mb-8 text-white leading-tight">
              <KineticText text="Verify Your " className="inline" type="words" />
            ...
            <ScrollReveal delay={0.6}>
              <p className="text-lg md:text-xl lg:text-2xl mb-8 md:mb-12 text-gray-300 max-w-4xl mx-auto leading-relaxed">
                Authenticate InlighnTech certificates with blockchain security and showcase your verified skills to
                employers worldwide
              </p>
            </ScrollReveal>
          </div>
        ...
        <section className="py-8 md:py-12 relative">
          <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8">
            <div className="text-center mb-6 md:mb-8">
              <h3 className="text-lg md:text-xl font-bold text-white mb-4">Try These Example Certificate IDs:</h3>
              <div className="flex flex-wrap justify-center gap-3 md:gap-4">
                {exampleCertificates.map((id) => (
                  <button
                    key={id}
                    onClick={() => copyToClipboard(id)}
                    className="flex items-center gap-2 bg-gray-800 border border-gray-700 rounded-lg px-3 md:px-4 py-2 md:py-3 hover:bg-gray-700 transition-all duration-200 group"
                  >
                    <code className="text-blue-400 font-mono text-sm md:text-base">{id}</code>
                    {copiedId === id ? (
              ...
              <p className="text-sm text-gray-400 mt-3">
                Click any ID above to copy it, then paste it in the verification form below
              </p>
            </div>
          </div>
        </section>
              ...
              <Card className="bg-gray-900 border-gray-700 shadow-2xl hover:shadow-3xl hover:border-blue-400 hover:shadow-blue-500/20 transition-all duration-300">
                <CardHeader className="text-center pb-6 md:pb-8">
                  ...
                  <p className="text-gray-300 text-lg md:text-xl">
                    Enter your certificate ID to verify its authenticity and view comprehensive details
                  </p>
                </CardHeader>
                  ...
                  <div className="space-y-6 md:space-y-8">
                    <div>
                      <Label
                        ...
                        className="text-white text-lg md:text-xl mb-3 md:mb-4 block font-semibold"
                      >
                        Certificate ID
                      </Label>
                      <div className="flex flex-col sm:flex-row gap-4 md:gap-6">
                        <Input
                          ...
                          className="bg-gray-800 border-gray-600 text-white placeholder:text-gray-400 text-lg md:text-xl py-3 md:py-4 px-4 md:px-6 rounded-xl flex-1"
                        />
                        <Button
                            ...
                            <Card className="bg-green-900/20 border-green-800 hover:shadow-xl hover:border-green-400 hover:shadow-green-500/20 transition-all duration-300">
                              <CardContent className="p-6 md:p-8 lg:p-10">
                                ...
                                <div className="grid md:grid-cols-2 gap-8 md:gap-12">
                                  <div className="space-y-4 md:space-y-6">
                                    <div className="flex items-center gap-3 md:gap-4">
                                      <div className="relative w-12 h-12 md:w-16 md:h-16 flex-shrink-0">
                                        <Image
                                          src={searchResult.studentImage || "/placeholder.svg"}
                                      ...
                                      <div>
                                        <p className="text-gray-400 text-xs md:text-sm font-medium">Student Name</p>
                                    ...
                                    <div className="flex items-center gap-3 md:gap-4">
                                      ...
                                      <div>
                                        <p className="text-gray-400 text-xs md:text-sm font-medium">Program</p>
                                        <p className="text-white font-bold text-lg md:text-xl">
                                    ...
                                    <div className="flex items-center gap-3 md:gap-4">
                                      ...
                                      <div>
                                        <p className="text-gray-400 text-xs md:text-sm font-medium">Final Grade</p>
                                        <p className="text-white font-bold text-lg md:text-xl">
                                          {searchResult.grade} ({searchResult.finalScore})
                                        </p>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div className="space-y-4 md:space-y-6">
                                    <div className="flex items-center gap-3 md:gap-4">
                                      ...
                                      <div>
                                        <p className="text-gray-400 text-xs md:text-sm font-medium">Completion Date</p>
                                        <p className="text-white font-bold text-lg md:text-xl">
                                ...
                                <div className="mt-6 md:mt-8">
                                  <p className="text-gray-400 text-xs md:text-sm font-medium mb-3 md:mb-4">
                                    Skills Mastered
                                  </p>
